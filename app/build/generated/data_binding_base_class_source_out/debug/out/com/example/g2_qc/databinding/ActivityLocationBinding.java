...
public final class ActivityLocationBinding implements ViewBinding {
  ...
  private ActivityLocationBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button saveLocationButton) {
    this.rootView = rootView;
    this.saveLocationButton = saveLocationButton;
  }
  ...
  public static ActivityLocationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.save_location_button;
      Button saveLocationButton = ViewBindings.findChildViewById(rootView, id);
      if (saveLocationButton == null) {
        break missingId;
      }

      return new ActivityLocationBinding((ConstraintLayout) rootView, saveLocationButton);
    }
