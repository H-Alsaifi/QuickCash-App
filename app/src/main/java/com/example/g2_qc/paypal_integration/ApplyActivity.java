...
public class ApplyActivity extends AppCompatActivity {
                    ...
                    if (result.getResultCode() == RESULT_OK) {
                        ...
                        if (confirmation != null) {
                            try {
                                ...
                                savePaymentDetailsToDatabase(payID, state, wageDouble);
    ...
    private void savePaymentDetailsToDatabase(String paymentId, String state, double wage) {
        ...
        final Payment payment = new Payment(userId, paymentId, state, wage);

        // Add the payment object to the database
        userPaymentsRef.push().setValue(payment)
                .addOnSuccessListener(aVoid -> Log.d(TAG, "Payment saved to database"))
